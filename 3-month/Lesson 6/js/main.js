...
// const sayHello2 = function (str) {
//   console.log(str);
// };
// sayHello2("Hello Two");

//! 3. Arrow function
// const sayHello3 = (str = "Salam", second = 5) => {
//   console.log(str, second);
// };
// sayHello3();

//* Amaliyot
// function hello(firstname = false) {
//   if (firstname) {
//     return `Assalamu alaikum ${firstname}!`;
//   } else {
//     return "Assalamu alaikum hurmatli mijoz!";
//   }
// }
// console.log(hello());
...
// users[users.length] = "Userbek";
// users[users.length] = "Mishkabek";
// console.log(users);
